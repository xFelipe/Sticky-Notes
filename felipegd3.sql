...
INSERT INTO TRUA VALUES (3,3,3, 'JACOBINA');
INSERT INTO TRUA VALUES (4,3,3, 'JOA DA SILVA');
SELECT * FROM TRUA;
...
INSERT INTO TPESSOA VALUES(3 , 'F', 'PEDRO', 'F',4 ,'1235');
...
--Desabilitando e habilitando constraint
ALTER TABLE TPESSOA DISABLE CONSTRAINT UK_CPF;
ALTER TABLE TPESSOA ENABLE CONSTRAINT UK_CPF;
SELECT * FROM ALL_CONSTRAINTS WHERE CONSTRAINT_NAME = 'UK_CPF';
